...
//Schema for updating prodcuts

export const updateProductsSchema = insertProductsSchema.extend({
  id: z.string().min(1, "Id is required"),
});

// Schema for stigning users in
export const signInFormSchema = z.object({
  email: z.email("Invalid email address"),
  password: z.string().min(6, "Password must be at least 6 charracters"),
});
...
export const cartItemSchema = z.object({
  ...
  qty: z.number().int().nonnegative("Quantity must be a positve number"),
...
export const insertCartSchema = z.object({
  ...
  userId: z.string().optional().nullable(), //Made it optional cause i want users to be able to add to cart without logging in
});
...
//Schema fotr updating user profile
export const updateUerProfileSchema = z.object({
  name: z.string().min(3, "Name must be at least 3 characters"),
...
export const updateUserSchema = updateUerProfileSchema.extend({
  id: z.string().min(1, "ID is required"),
  role: z.string().min(1, "Role is required"),
});

//Schema to insert reviews
export const inserReviewSchema = z.object({
